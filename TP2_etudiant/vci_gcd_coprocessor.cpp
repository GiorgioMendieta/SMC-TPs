...
namespace soclib
{
    namespace caba
    {
        ...
        template <typename vci_param> void VciGcdCoprocessor<vci_param>::transition()
        {
            if (!p_resetn.read())
            {
                r_vci_fsm = ; // TODO: A COMPLETER
                r_exe_fsm = ; // TODO: A COMPLETER
                return;
            }
            ...
            case VCI_GET_CMD:
                if (p_vci.cmdval.read())
                {
                    ...
                    r_srcid = ; // TODO: A COMPLETER
                    r_trdid = ; // TODO: A COMPLETER
                    r_pktid = ; // TODO: A COMPLETER
                    // test the command
        ...
        template <typename vci_param> void VciGcdCoprocessor<vci_param>::genMoore()
        {
            ...
            p_vci.rsrcid = ; // TODO: A COMPLETER
            p_vci.rtrdid = ; // TODO: A COMPLETER
            p_vci.rpktid = ; // TODO: A COMPLETER
            p_vci.rerror = ; // TODO: A COMPLETER
            p_vci.reop   = ; // TODO: A COMPLETER

            switch (r_vci_fsm)
            {
            case VCI_GET_CMD:
                p_vci.cmdack = ; // TODO: A COMPLETER
                p_vci.rspval = ; // TODO: A COMPLETER
                p_vci.rdata  = ; // TODO: A COMPLETER
                break;
            case VCI_RSP_OPA:
            case VCI_RSP_OPB:
            case VCI_RSP_START:
        ...
        template class VciGcdCoprocessor < soclib::caba::VciParams < ; // TODO: A COMPLETER> >;
