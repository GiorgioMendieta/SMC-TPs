...
namespace soclib
{
    namespace common
    {
        ...
        template <typename input_t, typename output_t> class AddressDecodingTable
        {
            ...
            inline input_t mask() const { return m_low_mask << m_drop_bits; }

            inline int id(input_t val) const { return (val >> m_drop_bits) & m_low_mask; }
          ...
          public:
            ...
            inline output_t operator[](input_t where) const { return m_table[id(where)]; }
