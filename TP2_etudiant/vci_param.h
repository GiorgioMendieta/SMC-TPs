...
namespace soclib
{
    namespace caba
    {
        ...
        static std::string VciParamsString(int b, int k, int n, int e, int q, int f, int s, int p, int t, int w)
        {
            std::ostringstream o;
            o << "vci_param<" << b << ',' << k << ',' << n << ',' << e << ',' << q << ',' << f << ',' << s << ',' << p
              << ',' << t << ',' << w << '>';
            return o.str();
        }
         ...
         */
        template <int cell_size, int plen_size, int addr_size, int rerror_size, int clen_size, int rflag_size,
                  int srcid_size, int pktid_size, int trdid_size, int wrplen_size>
        class VciParams
        {
            /* Obey standart */
