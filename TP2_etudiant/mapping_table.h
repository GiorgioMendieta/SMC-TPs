    ...
    namespace common
    {
        ...
        class MappingTable
        {
          ...
          public:
            ...
            MappingTable(size_t addr_width, const IntTab& level_addr_bits, const IntTab& level_id_bits,
            ...
            inline unsigned int indexForId(const IntTab& index) const { return index * m_level_id_bits; }
        };
