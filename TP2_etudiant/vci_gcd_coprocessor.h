...
namespace soclib
{
    namespace caba
    {
        ...
        /////////////////////////////
        template <typename vci_param> class VciGcdCoprocessor : public sc_core::sc_module
        {
          ...
          public:
            ...
            VciGcdCoprocessor(sc_core::sc_module_name insname, const soclib::common::IntTab& index,
