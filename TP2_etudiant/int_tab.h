...
namespace soclib
{
    namespace common
    {
        ...
        class IntTab
        {
          ...
          public:
            IntTab(value_t val0 = -1, value_t val1 = -1, value_t val2 = -1, value_t val3 = -1, value_t val4 = -1,
                   value_t val5 = -1, value_t val6 = -1, value_t val7 = -1, value_t val8 = -1, value_t val9 = -1)
            {
            ...
            IntTab(const IntTab& ref) { init(&ref.m_values[0]); }
            ...
            template <typename T> IntTab(const std::vector<T>& v)
            {
                value_t vals[s_max_level];
                size_t i = 0;
                while (i < v.size())
            ...
            IntTab(const value_t* vals) { init(vals); }
          ...
          public:
            ...
            bool operator!=(const IntTab& other) const { return !(*this == other); }
