...
namespace soclib
{
    namespace common
    {
        ...
        template <typename data_t> class AddressMaskingTable
        {
            ...
            inline data_t mask() const { return m_low_mask << m_drop_bits; }
          ...
          public:
            ...
            inline size_t getDrop() const { return m_drop_bits; }

            void print(std::ostream& o) const;

            inline data_t operator[](data_t where) const { return (where >> m_drop_bits) & m_low_mask; }
