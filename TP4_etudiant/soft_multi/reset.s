...
#get the processor id
    mfc0    $27, $15, 1 #prend la valeur du processeur
    andi    $27, 0x3    # proc_id % 4
...
proc1:
    ...
    # initializes interrupt vector
        la      $26,    _interrupt_vector   # interrupt vector address
        la      $27,    _isr_tty_get_task0             
        sw      $27,    52($26)             # interrupt_vector[5] <= _isr_dma
        la      $27,    _isr_timer              
        sw      $27,    36($26)            # interrupt_vector[9] <= _isr_ioc
        la      $27,    _isr_dma             
        sw      $27,    20($26)            # interrupt_vector[13] <= _isr_tty_get_task0
...
proc2:
    ...
    #initializes interrupt vector
        ...
        la      $27,    _isr_timer              
        sw      $27,    40($26)            # interrupt_vector[10] <= _isr_ioc
        la      $27,    _isr_dma             
